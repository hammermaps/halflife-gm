...
function EFFECT:Render()
        ...
        if particle then
            ...
            particle:SetColor(self.colors[self.colorIndex].r, self.colors[self.colorIndex].g, self.colors[self.colorIndex].b)  
            particle:SetCollide(true) 
            particle:SetGravity(Vector(0, 0, -500))  
        end

        if particle2 then
            particle2:SetVelocity(VectorRand() * 256)  
            ...
            particle2:SetColor(self.colors[self.colorIndex].r * 0.7, self.colors[self.colorIndex].g * 0.7, self.colors[self.colorIndex].b * 0.7)  
